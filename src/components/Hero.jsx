  ...
  return (
    ...
    <div className="container relative" ref={parallaxRef}>
        ...
        mx-auto text-center mb-[4rem] md:mb-20 lg:mb:[6rem]">
            ...
            text-n-2 lg:mb-8">
            Software Engineer @miniOrange | Amazon ML Summer'23 | SIH'23 Finalist | Samsung SFT - Top 50 | Mentor at GSSoC'23 | Technical Writer | Gold mlsa | Google Women TechMaker
            </p>
